const inputText = document.getElementById('texto_entrada');
const botaoResetar = document.getElementById('botao_reiniciar');
const resetarPagina = document.getElementById('botao_reiniciar');
    ...
    let textArea = document.querySelector("texto_entrada");
    ...
    document.getElementById("botao_decodifica").addEventListener("click", decodificar);
    document.getElementById("botao_copiar").addEventListener("click", copiarTexto);
    document.getElementById("botao_reiniciar").addEventListener("click", resetar);



    botaoResetar.addEventListener('click', () => resetar());
    resetarPagina.addEventListener('click', () => startPage());
